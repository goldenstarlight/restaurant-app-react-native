    ...
    return (
      <ScrollView style={{backgroundColor: '#F8F8F8', height: '100%'}}>
        ...
        <View style={styles.container}>
          ...
          <Text style={{fontSize: 14, color: '#fff', fontWeight: 'bold', paddingTop: 30}}>Confirmed</Text>
        ...
        <View style={styles.bodyContent}>
          <Image source={require('../assets/home/complete.png')}></Image>
            <View style={styles.order}>
              <TouchableOpacity onPress={this.goToRate.bind(this)}>  
                <Image source={require('../assets/home/check_status.png')}></Image>
              </TouchableOpacity>
            </View>
        </View>
      </ScrollView>
